...
<body>
   ...
   <div class="col-sm-6">
      <img src="resources/bootstrap/img/loginimage.png" class="img-responsive" style="width:100%" alt="Image">
      <p>Current Project</p>
    </div>
                     <div class="col-sm-6">
  ...
  <button type="submit" class="btn btn-default">Take Me in</button>
</form>
    </div>                
                </div>
            </div>
