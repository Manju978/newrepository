...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <img src="resources/bootstrap/img/dress.jpg"/>
                
      </div>

      <div class="item">
        <img src="resources/bootstrap/img/jewel.jpg" alt="Image2">
        
      </div>
      <div class="item">
        <img src="resources/bootstrap/img/bags.jpg" alt="Image2">
  ...
  <h3>Bored of the same look everyday????????</h3><br>
  <div class="row">
    <div class="col-sm-4">
      <img src="resources/bootstrap/img/look6.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Party in Stunning Mode</p>
    </div>
    <div class="col-sm-4"> 
      <img src="resources/bootstrap/img/look2.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Lovely Casuals</p>    
    </div>
    <div class="col-sm-4">
      <img src="resources/bootstrap/img/look3.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Be a cool bussiness woman</p>
      </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container text-center">    
  <h3>Purely Pink is dedicated in giving all the things a women wardrobe is craving for.....</h3><br>
  <div class="row">
    <div class="col-sm-4">
      <img src="resources/bootstrap/img/bag1.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Pack in a bag</p>
    </div>
    <div class="col-sm-4"> 
      <img src="resources/bootstrap/img/things2.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Step out in style</p>    
    </div>
    <div class="col-sm-4">
      <img src="resources/bootstrap/img/things3.jpg" class="img-responsive" style="width:100%" alt="Image">
